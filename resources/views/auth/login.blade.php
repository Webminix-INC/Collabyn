    ...
    <div class="card-body">
        ...
        <div class="custom-login-form">
            <div class="form-group mb-3">
                ...
                {{ Form::text('email', null, ['class' => 'form-control', 'placeholder' => __('Email'), 'required' => 'required']) }}
                @error('email')
            ...
            <div class="form-group mb-3">
                ...
                {{ Form::password('password', ['class' => 'form-control', 'placeholder' => __('Password'), 'id' => 'input-password', 'required' => 'required']) }}
                @error('password')
            ...
            <div class="form-group mb-4">
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    @if (Route::has('password.request'))
                        <span><a class="forgot-password-a" href="{{ route('password.request', $lang) }}"
            ...
            <div class="d-grid">
                {{ Form::submit(__('Login'), ['class' => 'login-button mt-2', 'id' => 'saveBtn']) }}
            </div>
