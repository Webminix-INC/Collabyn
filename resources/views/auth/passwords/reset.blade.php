...
@section('content')
    <div class="card-body">
        <div>
            <h2 class="forgot-password-title">{{ __('Reset Password') }}</h2>
    ...
    <div class="">
        ...
        <div class="form-group mb-3">
            ...
            {{Form::password('password',array('class'=>'form-control' , 'placeholder'=>__('New Password')))}}
            @error('password')
        ...
        <div class="form-group mb-3">
            ...
            {{Form::password('password_confirmation',array('class'=>'form-control' , 'placeholder'=>__('Confirm New Password')))}}
        ...
        <div class="d-grid">
            {{Form::submit(__('Reset'),array('class'=>'forgot-password-button mt-2','id'=>'resetBtn'))}}
        </div>
