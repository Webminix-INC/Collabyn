        ...
        <div class="left-content">
          ...
          <section class="engagement-section">
            <div class="header-content">
              <h1 class="main-title">Keep Track</h1>
                ...
                <div class="chart-wrapper">
                  ...
                  <div class="chart-area">
                    ...
                    <svg class="chart-svg" viewBox="0 0 400 180" preserveAspectRatio="none">
                      ...
                      <!-- Area fill -->
                      <path
                        d="M 0 140 L 60 120 L 120 100 L 180 80 L 240 60 L 300 40 L 360 20 L 400 10 L 400 180 L 0 180 Z"
                        fill="url(#chartGradient)"
                      />
                      
                      <!-- Line -->
                      <path
                        d="M 0 140 L 60 120 L 120 100 L 180 80 L 240 60 L 300 40 L 360 20 L 400 10"
                        stroke="#3b82f6"
                        stroke-width="2"
                        fill="none"
                      />
                      ...
                      <circle cx="400" cy="10" r="3" fill="#3b82f6" />
                    </svg>
